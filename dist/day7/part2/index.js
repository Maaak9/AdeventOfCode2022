...
var FileSystemNode = /** @class */ (function () {
    function FileSystemNode(_a) {
        var name = _a.name, parent = _a.parent, children = _a.children, size = _a.size, dirSize = _a.dirSize;
        this.name = name;
        this.parent = parent;
    ...
    FileSystem.prototype.print = function () {
        ...
        var traverseTree = function (tree) {
            tree.forEach(function (node) {
                console.log('--' + Array(indent).join('--'), node.name, "  --- ", node.size, "----", node.dirSize);
...
var buildFileSystem = function (instructions) {
    var rootNode = new FileSystemNode({ name: "root", children: [], parent: undefined, size: undefined });
    ...
    instructions.forEach(function (i) {
        ...
        if (instruction.match(/cd \.\./)) {
            ...
            if (childNode[0]) {
                ...
                fileSystem.addChildNode(new FileSystemNode({ name: folderName_1, parent: fileSystem.currentNode, children: [], size: undefined }));
            }
        }
...
var currentUsedSize = fileSystem.rootNode.dirSize;
var freeSpace = totalDiskSize - currentUsedSize;
var minimumSpaceNeeded = updateSize - freeSpace;
var smallestDirNeeded = 100000000;
dirSizes.sort().forEach(function (dirSize) {
    if (dirSize > minimumSpaceNeeded && dirSize < smallestDirNeeded) {
        smallestDirNeeded = dirSize;
    }
});
console.log('smallestDirNeeded', smallestDirNeeded);
